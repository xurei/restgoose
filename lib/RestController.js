...
exports.ERROR_BAD_FORMAT_CODE = 'BAD_FORMAT';
            ...
            if (error instanceof rest_1.RestError) {
                ...
                if (error.path === '_id') {
                    ...
                    return res.status(400).json({
                        code: exports.ERROR_BAD_FORMAT_CODE,
                        field: error.path,
                    });
                }
            }
            else if (error.name === exports.ERROR_VALIDATION_NAME) {
                return res.status(400).json({ code: exports.ERROR_VALIDATION_CODE, errors: error.errors });
            }
            else {
                console.error(error);
